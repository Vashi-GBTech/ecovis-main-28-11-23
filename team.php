...
<div class="row justify-content-around " style="margin: 2.5rem 0rem;"></div>

<div class="teamMets">
    <div class="justify-content-center mx-0 row">
        <div class="col-md-5 " id="ManagementBoard">
            <div class="text-center mb-4">
                <h1 class="text-center primaryHeading ">Management Board</h1>
            </div>
        ...
        <div class="col-md-7 ">
            ...
            <div class="">
                <ul class='circle-container' id="COEBoard">
